...
export default async function handler(
	...
	if (req.method === 'GET') {
		try {
			...
			const collection = db.collection('subscribes'); // Replace with your collection name

			// Query to find documents with the specified email
			const query = { email: 'shivanshupathak814@gmail.com' };
			...
			console.error('Error retrieving email data from MongoDB:', error);
